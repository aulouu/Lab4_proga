...
public class Main {
    public static void main(String[] args) throws ThisLocation {
        ...
        if ((piglet.getLoc() == null) || (winnieThePooh.getLoc() == null) || (all.getLoc() == null)) {
            throw new ThisLocation("Локация не задана");
        }
        ...
        if (((winnieThePooh.getLoc() == LocationForPerson.AREA) || (all.getLoc() == LocationForPerson.AREA))){
            area.expedition();
            christopherRobin.go();
            rabbit.go();
            piglet.go();
